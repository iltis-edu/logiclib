parser grammar FormulaSetParser;

import FormulaParser;

options {superClass=AbstractParser; tokenVocab=FormulaTokens;}
...
formulaSetSet
	...
	// missing braces
	// have to placed beneath the first case to deal with ambiguities for input {} and { R(x) }
