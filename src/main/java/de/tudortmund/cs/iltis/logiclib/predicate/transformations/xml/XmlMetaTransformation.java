...
import de.tudortmund.cs.iltis.utils.tree.transformations.MetaTransformation;
...
public class XmlMetaTransformation extends XmlTransformation {
    ...
    protected Transformation<TermOrFormula> parseTransformation(
        ...
        return new MetaTransformation<TermOrFormula>(path, parts.toArray(new Transformation[0]));
    }
}
