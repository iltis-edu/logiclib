...
DIR=../src/main/java/de/tudortmund/cs/iltis/logiclib/io/parser/modal/formula
GRAMMARNAME=ModalFormulaSetParser.g4
PCKG=de.tudortmund.cs.iltis.logiclib.io.parser.modal.formula
