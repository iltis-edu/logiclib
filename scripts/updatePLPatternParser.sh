...
DIR=../src/main/java/de/tudortmund/cs/iltis/logiclib/io/parser/predicate/formula/pattern
GRAMMARNAME=PatternParser.g4
PCKG=de.tudortmund.cs.iltis.logiclib.io.parser.predicate.formula.pattern
