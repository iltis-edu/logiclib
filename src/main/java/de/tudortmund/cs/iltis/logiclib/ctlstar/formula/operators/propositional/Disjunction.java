...
public class Disjunction extends CtlStarFormula {

    /** needed for serialization */
    @SuppressWarnings("unused")
    private Disjunction() {}

    public Disjunction(final CtlStarFormula... subformulae) {
        super(false, subformulae);
        if (getArity() == 0)
            throw new IllegalArgumentException("a disjunction needs at least 2 operands!");
    }
