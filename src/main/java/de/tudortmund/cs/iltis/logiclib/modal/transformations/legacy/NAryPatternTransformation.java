...
public class NAryPatternTransformation extends PatternTransformation implements NAryTransformation {
    ...
    public NAryPatternTransformation(String match, String replace) {
        this(Collections.emptyList(), match, replace);
    }

    public NAryPatternTransformation(String match, String replace, Set<String> relevantIds) {
        this(Collections.emptyList(), match, replace);
    }

    public NAryPatternTransformation(
            final Collection<TreePath> paths,
    ...
    public NAryPatternTransformation(
            final Collection<TreePath> paths, String match, String replace) {
        super(match, replace);
        setup(paths);
    }
    ...
    public boolean isApplicable(ModalFormula formula) {
        ...
        return matchPattern.matches(formula);
    }
    ...
    public ModalFormula apply(ModalFormula formula) {
        ...
        Match<ModalFormula> match = matchPattern.getFirstMatchIfAny(formula).get();
        return replaceSubformula(formula, new TreePath(), replacePattern.createTree(match));
    }
